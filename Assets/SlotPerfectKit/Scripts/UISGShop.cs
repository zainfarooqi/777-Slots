...
namespace BE {
	...
	public class UISGShop : MonoBehaviour {
		...
		void Awake () {
			...
			ItemList.Add(new ShopItemDef("shopitem0", 100, 30, "99.99$"));
			ItemList.Add(new ShopItemDef("shopitem0", 65, 20, "49.99$"));
			ItemList.Add(new ShopItemDef("shopitem0",  50, 15, "19.99$"));
			ItemList.Add(new ShopItemDef("shopitem0",  35, 10, "9.99$"));
			ItemList.Add(new ShopItemDef("shopitem0",   25,  5, "4.99$"));
			ItemList.Add(new ShopItemDef("shopitem0",   15,  2, "1.99$"));
