namespace Curiologix
{
    ...
    public class FortuneWheel : MonoBehaviour
    {
        ...
        private void Start()
        {
            goldcoins = PlayerPrefs.GetFloat("Credit", 5000);
            coinstext.text = goldcoins.ToString("0");
        }
        void Awake()
        {
        ...
        void GivePrize()
        {
            ...
            string winamount = FortuneWheelConfig.Instance.prizes[SelectedReward].ToString();

            goldcoins += (float.Parse(winamount));

            PlayerPrefs.SetFloat("Credits", goldcoins);
            coinstext.text = goldcoins.ToString("0");
